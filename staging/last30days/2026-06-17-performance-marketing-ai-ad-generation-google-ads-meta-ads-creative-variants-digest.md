...
> Status: staged
> Compile Recommendation: promote as trend evidence; use Anthropic official marketing capture for exact performance workflow claims.

## Strong Signals

- The repeated workflow is creative variant generation plus platform-specific constraints, not generic ad copywriting.
- Meta and Google Ads examples cluster around creative diversity, rapid variant production, ad account feedback, and CSV/export workflows.
- Anthropic's official growth-marketing capture is the strongest proof point: Claude Code compressed ad-creation workflows and generated Google Ads RSA assets through a reviewed export flow.
- The Hesamation/Ole Lehmann X capture is useful as social corroboration and a future manual-capture lead, but it should be cited as third-party social evidence.
...
- n8n autonomous ad studio examples if they include workflow diagrams or templates.
- Any Meta/Google primary docs on AI creative diversity and campaign automation.
- The original Ole Lehmann material behind the Hesamation quote thread, if available.
