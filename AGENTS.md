...
2. `staging/` holds incomplete captures, Signal Sweep digests, and material that is useful but not yet durable truth.
...
9. Signal Sweep output is lower-trust recent signal until promoted with source-backed reasoning.
