...
1. **Brief:** product, audience, offer, claim boundaries, target platform, desired creator/persona, visual style, and compliance constraints.
2. **Script:** hook, problem, product moment, proof, CTA, disclosure language, and variant angles.
3. **Persona/scene:** creator identity, setting, camera, lighting, wardrobe, props, product integration, and platform-native feel.
4. **Generation:** image/avatar/video model, voice, b-roll, captions, music, and edit assembly.
5. **Review:** disclosure, rights, likeness, policy, product truth, brand safety, and uncanny/deceptive feel.
6. **Testing:** ship approved variants into paid-social or organic tests, then feed performance back into the next brief.

## Governance Notes

- Avoid impersonating real people or implying real endorsements without rights and disclosure.
- Keep generated UGC distinguishable enough for internal traceability even if it is styled like native creator content.
- Prefer product demos, fictional personas, and clearly approved synthetic assets over fake influencer claims.
- Tie UGC variants to performance measurement; otherwise the workflow becomes content volume without learning.
